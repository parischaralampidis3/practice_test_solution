...
class main implements \renderable, \templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        foreach($records as $record){
            //changed value of $record->timemodified to $record->timecreated to fetch the timecreated value
            $timecreated=date('d/m/Y H:i:s',$record->timecreated);
            //include the $timecreated variable at the loop in order to display properly
